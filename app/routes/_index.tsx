...
export default function Index() {
  ...
  const movieDataMarkdown = data.results.map((movie: any) => (
    <div className="flex flex-col overflow-hidden rounded-lg border bg-white">
      ...
      >
        <img
          ...
          alt=""
          className="absolute inset-0 h-full w-full object-cover object-center transition duration-2BB group-hover:scale-110"
        />
      </Link>
